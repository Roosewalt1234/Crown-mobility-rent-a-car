  ...
  try {
    ...
    if (fleetData && fleetData.length > 0) {
      const fleetString = fleetData.map(car => {
        ...
        `ID: ${car.vehicle_id}, Offer: ${car.offer}, Special Price: AED ${car.special_day_price || car.day_price}/day, Actual Price: AED ${car.daily_price}/day, Weekly: AED ${car.week_price}/week, Monthly: AED ${car.month_price}/month. ` +
